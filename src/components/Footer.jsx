  ...
  return (
    <footer className="bg-white text-gray-800 py-8 border-t">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 md:flex md:justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="font-semibold mb-2">Newsletter</h3>
            <p className="text-sm mb-2">Subscribe to our newsletter to get more free tip</p>
            <form className="flex gap-2">
              <input type="email" placeholder="Enter Your Email" className="border rounded px-3 py-2 w-full max-w-xs" />
              <button type="submit" className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded">Subscribe</button>
            </form>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          © 2023 PerfectRecipe. All Rights Reserved
        </div>
      </div>
    </footer>
  )
